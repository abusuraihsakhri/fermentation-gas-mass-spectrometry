"""
Data Models & Telemetry Definitions for OffGas-Analyzer: Fermentation Respiratory Quotient (RQ) & OUR/CER Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Bioprocess Off-Gas Analysis Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
