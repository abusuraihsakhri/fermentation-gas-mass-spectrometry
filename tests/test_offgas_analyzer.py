...
import pytest
from offgas_analyzer.models import FrontierPayload, ExecutionStatus
from offgas_analyzer.engine import FrontierDomainEngine
from offgas_analyzer.agents import OURKineticsCalculatorAgent, CEREvaluationAgent, RespiratoryQuotientAgent, OffGasCoordinator
from offgas_analyzer.cli import main


def test_sub_agents():
    a1 = OURKineticsCalculatorAgent()
...
def test_coordinator():
    ...
    assert "Bioprocess Off-Gas Analysis Standards" in ans or "specifications" in ans
