"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for fermentation-gas-mass-spectrometry.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Fermentation Gas Mass Spectrometry"):
